...
Callback.addCallback("PreLoaded", function(){
	Recipes.addShaped({id: BlockID.sink, count: 1, data: 0}, [
		"ara",
		"ara",
		"ara"
	], ["a", 265, 0, 'r', 17, -1]);
	Recipes.addShaped({id: BlockID.sink, count: 1, data: 1}, [
		"ara",
		"ara",
		"ara"
	], ["a", 265, 0, 'r', 1, -1]);
	Recipes.addShaped({id: BlockID.sink, count: 1, data: 2}, [
		"ara",
		"ara",
		"ara"
	], ["a", 265, 0, 'r', 82, 0]);
	Recipes.addShaped({id: BlockID.sink, count: 1, data: 3}, [
		"ara",
		"ara",
		"ara"
	], ["a", 265, 0, 'r', 1, -1]);
